...
magicPlot(p = all_interaction_plots_fig, filename = file.path(pub_results_dir, paste0("Figure_S10_InteractionResponse")),  width = 950, height = 800)

pdf(file = file.path(pub_results_dir, paste0("Figure_S10_InteractionResponse.pdf")), width = 9, height = 7)
print(all_interaction_plots_fig)
dev.off()

pdf(file = file.path(pub_results_dir, paste0("fig_S10.pdf")), width = 9, height = 7)
print(all_interaction_plots_fig)
dev.off()
